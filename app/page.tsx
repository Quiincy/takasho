      ...
      <main>
        ...
        <section style={{
          ...
          <div style={{ position: 'relative', zIndex: 1, maxWidth: 1280, margin: '0 auto' }}>
            ...
            >
              {[
                { icon: '🚕', title: 'Доставка', desc: 'Доставка за тарифом таксі. При замовленні від 1000 грн — 50% вартості оплачуємо ми. Мінімальна сума замовлення — 500 грн.', delay: '' },
                ...
                { icon: '💳', title: 'Зручна оплата',      desc: 'Оплачуйте замовлення безпечно та швидко онлайн за допомогою системи LiqPay.',                           delay: 'reveal-delay-2' },
