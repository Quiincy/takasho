...
4.3. Оплата здійснюється готівкою кур'єру або переказом на банківський рахунок/картку ФОП (Отримувач: ГУЛАК ДМИТРО СЕРГІЙОВИЧ, IBAN: UA493052990000026001046240837, РНОКПП: 3139607532, Призначення платежу: Поповнення рахунку).`,
  },
  {
    title: '5. Доставка',
    content: `5.1. Зона доставки — місто Київ та прилеглі райони.
5.2. Доставка до 1 км від ресторану (вул. Едуарда Вільде, 10Б, Дніпровський район) — безкоштовна при замовленні від 1000 грн.
5.3. В інших випадках вартість доставки розраховується за тарифом таксі. Мінімальна сума замовлення для доставки складає 500 грн.
...
Адреса: вул. Едуарда Вільде, 10Б, Дніпровський район, м. Київ
