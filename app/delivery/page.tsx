...
export default async function DeliveryPage() {
  ...
  const DELIVERY_ZONES = [
    { zone: 'Від 1000 грн', price: 'Тариф таксі (50% оплачуємо ми) 🎉', color: '#48c774', bg: 'rgba(72,199,116,0.08)', border: 'rgba(72,199,116,0.25)' },
    { zone: 'До 1000 грн', price: 'За тарифом таксі', color: 'var(--accent-gold)', bg: 'rgba(244,162,97,0.08)', border: 'rgba(244,162,97,0.25)' },
...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Доставка здійснюється за тарифом таксі. При замовленні від 1000 грн ми оплачуємо 50% вартості доставки, а при замовленні до 1000 грн доставку повністю оплачує клієнт.',
  },
  {
    ...
    <main style={{ minHeight: '100vh', background: 'var(--bg-primary)' }}>
      ...
      >
        ...
        <p style={{ fontSize: 16, color: 'var(--text-secondary)', maxWidth: 600, margin: '0 auto' }}>
          Ми знаходимось за адресою <strong>{shortAddress}</strong>. Доставка здійснюється за тарифом таксі. При замовленні від 1000 грн — 50% вартості доставки оплачуємо ми. Мінімальна сума замовлення для доставки — 500 грн.
        </p>
      </section>
