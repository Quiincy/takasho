...
export default async function DeliveryPage() {
  ...
  const DELIVERY_ZONES = [
    { zone: 'До 2 км', price: '70 ₴', color: '#48c774', bg: 'rgba(72,199,116,0.08)', border: 'rgba(72,199,116,0.25)' },
    { zone: 'Більше 2 км', price: '120 ₴', color: '#f4a261', bg: 'rgba(244,162,97,0.08)', border: 'rgba(244,162,97,0.25)' },
...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Вартість доставки залежить від відстані: до 2 км — 70 грн, більше 2 км — 120 грн.',
  },
  {
    ...
    <main style={{ minHeight: '100vh', background: 'var(--bg-primary)' }}>
      ...
      >
        ...
        <p style={{ fontSize: 16, color: 'var(--text-secondary)', maxWidth: 600, margin: '0 auto' }}>
          Ми знаходимось за адресою <strong>{shortAddress}</strong>. Вартість доставки залежить від відстані: 70 або 120 грн. Мінімальна сума замовлення для доставки — 500 грн.
        </p>
      </section>
