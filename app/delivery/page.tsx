...
export const metadata: Metadata = {
  ...
  description: 'Умови доставки Enot Sushi в Києві: безкоштовно в радіусі 1 км, оплата готівкою або через термінал. Доставка від 1 години. Мінімальне замовлення 500 грн.',
};
...
const PAYMENT_METHODS = [
  {
    icon: '💳',
    title: 'Оплата терміналом',
    desc: 'Оплата банківською карткою через термінал при отриманні замовлення.',
    badge: 'Зручно',
    badgeColor: '#48c774',
...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Так, наші кур\'єри завжди мають решту. Але щоб пришвидшити процес, просимо по можливості готувати точну суму або оплачувати карткою через термінал.',
  },
];
        ...
        <div style={{ marginBottom: 48 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {[
              ...
              { n: '3', text: 'Оберіть зручний спосіб оплати: готівкою або карткою через термінал при отриманні' },
